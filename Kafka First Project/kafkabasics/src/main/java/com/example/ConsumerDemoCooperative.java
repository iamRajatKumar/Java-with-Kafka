...
public class ConsumerDemoCooperative {
    ...
    public static void main(String[] args) {
        ...
        // set the partition assignment strategy to cooperative sticky assignor
        ...
        try {
            ...
            // consumer.poll() is the synchronous method that continuously fetches records from Kafka,
            //  sends heartbeats to the consumer group, manages rebalancing, and keeps the consumer alive. 
            // It is the core method of every Kafka consumer.
            while (true) {
